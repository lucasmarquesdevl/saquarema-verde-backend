Unifeso-Saquarema-Verde
Projeto MVP Mobile - Unifeso
...
Crie um serviço MySQL no Railway
Faça deploy do backend pelo GitHub
...
PORT=8080
Atualize BASE_URL no api.js do mobile com a URL gerada pelo Railway
